...
`,
		...
		},
		{
			...
			args: args{
				projectName: "github.com/incu6us/goimports-reviser",
				filePath:    "./testdata/example.go",
				fileContent: `// Code generated by xxx. DO NOT EDIT.
...
`,
			...
			want: `// Code generated by xxx. DO NOT EDIT.
...
func TestSourceFile_Fix_WithGeneratedFilesFormatting(t *testing.T) {
	type args struct {
		projectName string
		filePath    string
		fileContent string
...
`,
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			got, hasChange, err := NewSourceFile(tt.args.projectName, tt.args.filePath).Fix(WithGeneratedFilesFormatting)
			if (err != nil) != tt.wantErr {
				t.Errorf("Fix() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
